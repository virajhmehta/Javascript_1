...
const gameName = new String('Virajmehta'); // Object
...
const anotherString = temp.slice(-8, 4);// will start from reverse ( start index, end index ) so -8 is given so it starts from end and 4 is from start so -8 is 'l' 
// and 4 is 'o' so it is [) so prints 'l'
